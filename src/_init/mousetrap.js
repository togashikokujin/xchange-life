...
Mousetrap.bind('up', function() {
  var link = $('tw-hook[name="up"] tw-link');
  if (link) {
      link.click();
  }
});
...
Mousetrap.bind('down', function() {
  var link = $('tw-hook[name="down"] tw-link');
  if (link) {
      link.click();
  }
});
...
Mousetrap.bind('left', function() {
  var link = $('tw-hook[name="left"] tw-link');
  if (link) {
      link.click();
  }
});
...
Mousetrap.bind('right', function() {
  var link = $('tw-hook[name="right"] tw-link');
  if (link) {
      link.click();
  }
});
...
Mousetrap.bind('space', function() {
  var link = $('tw-hook[name="space"] tw-link');
  if (link) {
      link.click();
  }
});
...
Mousetrap.bind('shift', function() {
  var link = $('tw-hook[name="shift"] tw-link');
  if (link) {
      link.click();
  }
});
...
Mousetrap.bind('enter', function() {
  var link = $('tw-hook[name="enter"] tw-link');
  if (link) {
      link.click();
  }
});